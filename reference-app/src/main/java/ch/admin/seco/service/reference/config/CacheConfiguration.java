...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance() {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("referenceservice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("referenceservice");
        ...
        config.getMapConfigs().put("ch.admin.seco.service.reference.domain.*", initializeDomainMapConfig(jHipsterProperties));
